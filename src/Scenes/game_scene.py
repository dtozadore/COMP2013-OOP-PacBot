            ...
            for j in range(self.num_tiles_y):
                ...
                if tile is not None:
                    if tile == StaticMapState.WALL_VERTICAL:
                        ...
                        self.scene_manager.screen.blit(self.wall_t_top_right_tile, (x, y))
                    elif tile == StaticMapState.WALL_T_TOP_LEFT:
                        self.scene_manager.screen.blit(self.wall_t_top_left_tile, (x, y))
                    elif tile == StaticMapState.WALL_CORNER_NE:
                        self.scene_manager.screen.blit(self.wall_corner_ne_tile, (x, y))
                    elif tile == StaticMapState.WALL_CORNER_NW:
                        self.scene_manager.screen.blit(self.wall_corner_nw_tile, (x, y))
                    elif tile == StaticMapState.WALL_CORNER_SE:
                        self.scene_manager.screen.blit(self.wall_corner_se_tile, (x, y))
                    elif tile == StaticMapState.WALL_CORNER_SW:
                        self.scene_manager.screen.blit(self.wall_corner_sw_tile, (x, y))
